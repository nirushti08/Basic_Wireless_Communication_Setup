...
ldim2 = rep_find(J21(1:6,1));
lm2 = ldim2(1)/3;
ln2 = ldim2(2)/3;
dim_row2 = sum(ldim2);
dim2 = J21(7:6+dim_row2);
dim2 = rep_find(dim2);
m2 = str2num(erase(num2str(reshape(dim2(1:lm2),1,[]))," "));
n2 = str2num(erase(num2str(reshape(dim2(lm2+1:lm2+ln2),1,[]))," "));
J22 = J21(6+dim_row2+1:6+dim_row2+m2*n2,1);
J23 = reshape(J22,m2,n2);
...
ldim3 = rep_find(J31(1:6,1));
lm3 = ldim3(1)/3;
ln3 = ldim3(2)/3;
dim_row3 = sum(ldim3);
dim3 = J31(7:6+dim_row3);
dim3 = rep_find(dim3);
m3 = str2num(erase(num2str(reshape(dim3(1:lm3),1,[]))," "));
n3 = str2num(erase(num2str(reshape(dim3(lm3+1:lm3+ln3),1,[]))," "));
J32 = J31(6+dim_row3+1:6+dim_row3+m3*n3,1);
J33 = reshape(J32,m3,n3);
